            ...
            <div className={style.form_container}>
                <Form onSubmit={handleSubmit} style={{ width: isLogin ? '380px' : '500px', marginTop: isLogin ? '10vh' : '3vh' }} {...formItemLayout}>
                    ...
                    <FormItem label="用户名" >
                        {
                            ...
                            })(<Input prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} autoComplete='username' />)
                        }
                    </FormItem>
                    <FormItem label="密码" >
                        {
                            ...
                            })(<Input.Password prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />} autoComplete='current-password' />)
                        }
                    </FormItem>
                    {
                        !isLogin && <FormItem label="确认密码" >
                            {
                                ...
                                })(<Input.Password onBlur={this.handleRepasswordBlur} autoComplete='current-password' prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />} />)
                            }
                        </FormItem>
                    }
                    {
                    ...
                    <FormItem {...formLastItemLayout}>
                        ...
                        {isLogin ? '没有账号' : '已有账号'}<a href="#" onClick={changeLoginStatus}>{isLogin ? '立刻注册' : '立刻登录'}</a><br /><a href='' onClick={returnHome}>返回首页</a>
                    </FormItem>
                </Form>
            </div>)
    }
